  ...
  [195],
  {
      ...
      var t = F(5893),
        ...
        a = function (u) {
          ...
          return (0, t.jsxs)(e.default, {
            children: [
              ...
              (0, t.jsx)('meta', { name: 'description', content: F }),
              (0, t.jsx)('meta', {
                property: 'og:url',
                content: ''.concat(C().siteUrl).concat(s.asPath),
              }),
              (0, t.jsx)('meta', { property: 'og:type', content: n }),
              (0, t.jsx)('meta', { property: 'og:site_name', content: C().title }),
              (0, t.jsx)('meta', { property: 'og:description', content: F }),
              (0, t.jsx)('meta', { property: 'og:title', content: D }),
              'Array' === a.constructor.name
                ? a.map(function (u) {
                    var D = u.url
                    return (0, t.jsx)('meta', { property: 'og:image', content: D }, D)
                  })
                : (0, t.jsx)('meta', { property: 'og:image', content: a }, a),
              (0, t.jsx)('meta', { name: 'twitter:card', content: 'summary_large_image' }),
              (0, t.jsx)('meta', { name: 'twitter:site', content: C().twitter }),
              (0, t.jsx)('meta', { name: 'twitter:title', content: D }),
              (0, t.jsx)('meta', { name: 'twitter:description', content: F }),
              (0, t.jsx)('meta', { name: 'twitter:image', content: E }),
            ],
          })
        },
        E = function (u) {
        ...
        A = function (u) {
          var D = u.authorDetails,
            ...
            l = new Date(s || E).toISOString(),
            d = (0 === o.length ? [C().socialBanner] : 'string' === typeof o ? [o] : o).map(
              function (u) {
          ...
          return (0, t.jsxs)(t.Fragment, {
            children: [
              ...
              (0, t.jsxs)(e.default, {
                children: [
                  E && (0, t.jsx)('meta', { property: 'article:published_time', content: B }),
                  s && (0, t.jsx)('meta', { property: 'article:modified_time', content: l }),
                  (0, t.jsx)('link', {
                    rel: 'canonical',
                    href: ''.concat(C().siteUrl).concat(c.asPath),
                  }),
                  (0, t.jsx)('script', {
            ...
            children: [
              ...
              r &&
                (0, t.jsx)(e.Z, {
                  ...
                  children: (0, t.jsx)('button', { rel: 'previous', children: 'Previous' }),
                }),
              (0, t.jsxs)('span', { children: [F, ' of ', D] }),
              !n &&
                (0, t.jsx)('button', {
                  rel: 'next',
                  className: 'cursor-auto disabled:opacity-50',
              ...
              n &&
                (0, t.jsx)(e.Z, {
                  ...
                  children: (0, t.jsx)('button', { rel: 'next', children: 'Next' }),
                }),
            ],
          }),
        })
        ...
        return (0, t.jsxs)(t.Fragment, {
          children: [
            ...
            A &&
              A.totalPages > 1 &&
              !o &&
              (0, t.jsx)(C, { currentPage: A.currentPage, totalPages: A.totalPages }),
          ],
        })
      }
    },
    ...
    5705: function (u, D, F) {
      ...
      function E(u) {
        ...
        return (0, t.jsxs)(t.Fragment, {
          children: [
            (0, t.jsx)(C.TQ, { title: 'Blog', description: r().description }),
            (0, t.jsx)(n.default, {
              posts: D,
