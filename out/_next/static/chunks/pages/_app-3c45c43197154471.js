    ...
    4642: function (e, t, n) {
      ...
      var y = {
          ...
          linkedin: function (e) {
            return i.createElement(
              'svg',
              p({ viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' }, e),
              h ||
    ...
    8418: function (e, t, n) {
      ...
      var d = function (e) {
        ...
        var w = (t = i.default.Children.only(h)) && 'object' === typeof t && t.ref,
          b = a(s.useIntersection({ rootMargin: '200px' }), 2),
          x = b[0],
          _ = b[1],
        ...
        if (e.passHref || ('a' === t.type && !('href' in t.props))) {
          var Z = 'undefined' !== typeof y ? y : r && r.locale,
            k =
              r && r.isLocaleDomain && l.getDomainLocale(m, Z, r && r.locales, r && r.domainLocales)
          O.href = k || l.addBasePath(l.addLocale(m, Z, r && r.defaultLocale))
        }
        ...
        g = function () {
          return (0, r.BX)(r.HY, {
            children: [
              ...
              l().analytics.simpleAnalytics && (0, r.tZ)(p, {}),
          ...
          children: (0, r.BX)('div', {
            ...
            children: [
              (0, r.BX)('div', {
                ...
                children: [
                  (0, r.tZ)(O.Z, { kind: 'mail', href: 'mailto:'.concat(l().email), size: '6' }),
                  (0, r.tZ)(O.Z, { kind: 'github', href: l().github, size: '6' }),
                  (0, r.tZ)(O.Z, { kind: 'facebook', href: l().facebook, size: '6' }),
                  (0, r.tZ)(O.Z, { kind: 'youtube', href: l().youtube, size: '6' }),
                  (0, r.tZ)(O.Z, { kind: 'linkedin', href: l().linkedin, size: '6' }),
                  (0, r.tZ)(O.Z, { kind: 'twitter', href: l().twitter, size: '6' }),
                ],
              }),
              (0, r.BX)('div', {
      ...
      function I(e) {
        ...
        return (0, r.BX)(a.f, {
          ...
          children: [
            ...
            false,
            (0, r.tZ)(g, {}),
            (0, r.tZ)(j, { children: (0, r.tZ)(t, N({}, n)) }),
          ],
        })
      }
    },
        ...
        var t = {
            162: function (e) {
              ...
              ;(r.nextTick = function (e) {
                ...
                c.push(new m(e, t)), 1 !== c.length || s || i(d)
              }),
