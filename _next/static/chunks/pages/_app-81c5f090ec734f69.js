  ...
  [888],
  {
    ...
    4373: function (e, t, n) {
      ...
      t.Z = function (e) {
        var t = e.href,
          ...
          l = t && t.startsWith('#')
        return i
          ? (0, r.jsx)(a.default, { href: t, children: (0, r.jsx)('a', o({}, n)) })
          : l
          ? (0, r.jsx)('a', o({ href: t }, n))
          : (0, r.jsx)('a', o({ target: '_blank', rel: 'noopener noreferrer', href: t }, n))
      }
    },
    9072: function (e, t, n) {
      'use strict'
    ...
    8045: function (e, t, n) {
      ...
      t.default = function (e) {
        ...
        'layout' in Z && (Z.layout && (D = Z.layout), delete Z.layout)
        var U = ''
        if (
          (function (e) {
            return (
          ...
          if (
            ...
            (U = V.src),
            (!D || 'fill' !== D) &&
              ((S = S || V.height), (O = O || V.width), !V.height || !V.width))
          )
            throw new Error(
        ...
        var q = E(O),
          B = E(S),
          H = E(j),
          W = !d && ('lazy' === m || 'undefined' === typeof m)
        ;(n.startsWith('data:') || n.startsWith('blob:')) && ((c = !0), (W = !1))
        ;(null === (t = R.current) || void 0 === t ? void 0 : t.complete) && (W = !1)
        0
        var F,
          K = i(f.useIntersection({ rootRef: y, rootMargin: w, disabled: !W }), 2),
          X = K[0],
          G = K[1],
          J = !W || G,
          $ = {
        ...
        if ('fill' === D)
          ($.display = 'block'),
            ...
            ($.bottom = 0),
            ($.right = 0)
        else if ('undefined' !== typeof q && 'undefined' !== typeof B) {
          var ne = B / q,
            re = isNaN(ne) ? '100%' : ''.concat(100 * ne, '%')
          'responsive' === D
            ? (($.display = 'block'), ($.position = 'relative'), (Q = !0), (Y.paddingTop = re))
            : 'intrinsic' === D
        ...
        J &&
          (ae = k({ src: n, unoptimized: c, layout: D, width: q, quality: H, sizes: r, loader: z }))
        var ie = n
        0
        var oe
        0
      ...
      var l,
        ...
        u = (l = n(5443)) && l.__esModule ? l : { default: l },
        d = n(5809),
        f = n(7190)
      function m(e, t, n) {
        return (
      ...
      var g = new Map([
        ...
        [
          ...
          function (e) {
            ...
            return ''.concat(t).concat(i).concat(S(n))
          },
        ],
        [
          'akamai',
          function (e) {
            var t = e.root,
              n = e.src,
              r = e.width
            return ''.concat(t).concat(S(n), '?imwidth=').concat(r)
          },
        ],
        [
          'custom',
      ...
      function k(e) {
        ...
        return {
          ...
          srcSet: u
            ...
            .join(', '),
          src: l({ src: t, quality: i, width: u[f] }),
        }
      }
      function E(e) {
    ...
    8418: function (e, t, n) {
      ...
      var f = function (e) {
        ...
        if (e.passHref || ('a' === t.type && !('href' in t.props))) {
          ...
          k.href = A || c.addBasePath(c.addLocale(m, E, r && r.defaultLocale))
        }
    ...
    1802: function (e, t, n) {
      ...
      var r = n(5893),
        ...
        u = function (e) {
          var t = e.forcedTheme,
            ...
            j = e.attribute,
            O = void 0 === j ? 'data-theme' : j,
            k = e.value,
            E = e.children,
            A = (0, a.useState)(function () {
              return f(v, x)
            }),
            S = A[0],
            T = A[1],
            ...
            I = _[0],
            L = _[1],
            z = k ? Object.values(k) : b,
            C = (0, a.useCallback)(
              function (e) {
                var n = h(e)
                L(n), 'system' !== S || t || P(n, !1)
              },
              [S, t]
            ),
            N = (0, a.useRef)(C)
          ...
          var P = (0, a.useCallback)(function (e, t, n) {
            ...
            if ('system' === e && c) {
              var o = h()
              a = (null == k ? void 0 : k[o]) || o
            }
            if (n) {
              var l,
                s = document.documentElement
              'class' === O
                ? ((l = s.classList).remove.apply(l, z), s.classList.add(a))
                : s.setAttribute(O, a),
                null == i || i()
            }
          }, [])
          ;(0, a.useEffect)(function () {
            var e = function () {
                return N.current.apply(N, [].slice.call(arguments))
              },
              t = window.matchMedia(s)
            return (
              t.addListener(e),
              e(t),
              function () {
          ...
          return (
            ...
            (0, a.useEffect)(
              function () {
                if (p) {
                  var e =
                    t && l.includes(t) ? t : S && l.includes(S) ? S : ('system' === S && I) || null
            ...
            a.createElement(
              o.Provider,
              {
                value: {
                  ...
                  setTheme: M,
                  forcedTheme: t,
                  resolvedTheme: 'system' === S ? I : S,
                  themes: c ? [].concat(b, ['system']) : b,
                  systemTheme: c ? I : void 0,
                },
              },
              a.createElement(d, {
                forcedTheme: t,
      ...
      var b,
        w = function () {
          return (0, r.jsxs)(r.Fragment, {
            children: [
              (0, r.jsx)(v.default, {
                strategy: 'lazyOnload',
                'data-domain': g().analytics.plausibleDataDomain,
        ...
        j = function () {
          return (0, r.jsx)(r.Fragment, {
            children: (0, r.jsx)(v.default, {
              async: !0,
              defer: !0,
              'data-website-id': g().analytics.umamiWebsiteId,
        ...
        O = function () {
          return (0, r.jsxs)(r.Fragment, {
            children: [
              g().analytics.plausibleDataDomain && (0, r.jsx)(w, {}),
              g().analytics.simpleAnalytics && (0, r.jsx)(x, {}),
              g().analytics.umamiWebsiteId && (0, r.jsx)(j, {}),
              g().analytics.googleAnalyticsId && (0, r.jsx)(y, {}),
            ],
          })
        },
        k = [
      ...
      var _ = function (e) {
          return a.createElement(
            'svg',
            T({ width: 162, height: 16, xmlns: 'http://www.w3.org/2000/svg' }, e),
            A ||
          ...
          children: (0, r.jsxs)('div', {
            ...
            children: [
              (0, r.jsxs)('div', {
                ...
                children: [
                  (0, r.jsx)(z.Z, { kind: 'blog', href: g().blog, size: '6' }),
                  (0, r.jsx)(z.Z, { kind: 'facebook', href: g().facebook, size: '6' }),
                  (0, r.jsx)(z.Z, { kind: 'instagram', href: g().instagram, size: '6' }),
                ],
              }),
              (0, r.jsx)('div', {
                className: 'mb-6 flex space-x-2 text-sm text-gray-500 dark:text-gray-400',
                children: (0, r.jsx)('div', { children: g().author }),
              }),
            ],
          }),
        })
                ...
                children: [
                  ...
                  (0, r.jsx)('nav', {
                    ...
                    children: k.map(function (e) {
                      return (0,
                      r.jsx)('div', { className: 'px-12 py-4', children: (0, r.jsx)(I.Z, { href: e.href, className: 'text-2xl font-bold tracking-widest text-gray-900 dark:text-gray-100', onClick: i, children: e.title }) }, e.title)
                    }),
                  }),
                ],
              }),
        ...
        P = function () {
          ...
          return (
            ...
            (0, r.jsx)('button', {
              ...
              onClick: function () {
                return l('dark' === o || 'dark' === s ? 'light' : 'dark')
              },
              children: (0, r.jsx)('svg', {
                xmlns: 'http://www.w3.org/2000/svg',
                viewBox: '0 0 20 20',
          ...
          return (0, r.jsx)(L.Z, {
            children: (0, r.jsxs)('div', {
              ...
              children: [
                    ...
                    (0, r.jsx)('div', {
                      children: (0, r.jsx)(I.Z, {
                        ...
                        children: (0, r.jsx)('div', {
                          ...
                          children: (0, r.jsx)('div', {
                            className: 'mr-3',
                            children: 'light' === a ? (0, r.jsx)(S, {}) : (0, r.jsx)(_, {}),
                          }),
                        }),
                      }),
                    }),
                ...
                (0, r.jsx)('main', { className: 'mb-auto', children: t }),
                (0, r.jsx)(C, {}),
              ],
            }),
          })
      ...
      function U(e) {
        ...
        return (0, r.jsxs)(u, {
          ...
          children: [
            ...
            false,
            (0, r.jsx)(O, {}),
            (0, r.jsx)(M, { children: (0, r.jsx)(t, D({}, n)) }),
          ],
        })
      }
    },
        ...
        var t = {
            162: function (e) {
              ...
              var c,
                ...
                u = -1
              function d() {
                s && c && ((s = !1), c.length ? (l = c.concat(l)) : (u = -1), l.length && f())
              }
              function f() {
                if (!s) {
                  var e = o(d)
              ...
              ;(r.nextTick = function (e) {
                ...
                l.push(new m(e, t)), 1 !== l.length || s || o(f)
              }),
