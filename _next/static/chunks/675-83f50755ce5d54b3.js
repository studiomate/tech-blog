  ...
  [675],
  {
    8045: function (t, e, n) {
      ...
      e.default = function (t) {
        ...
        0
        var J,
          G = o(f.useIntersection({ rootRef: b, rootMargin: w, disabled: !V }), 2),
          Q = G[0],
          $ = G[1],
          K = !V || $,
          X = {
        ...
        if ('fill' === M)
          ...
          'responsive' === M
            ? ((X.display = 'block'), (X.position = 'relative'), (Z = !0), (Y.paddingTop = rt))
            : 'intrinsic' === M
        ...
        K &&
          (it = O({ src: n, unoptimized: c, layout: M, width: H, quality: F, sizes: r, loader: R }))
        var ot = n
        0
        var at
        0
